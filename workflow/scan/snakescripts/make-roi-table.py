...
excessregion=snakemake.input.excessregion
windowed=snakemake.input.windowed
roitable=snakemake.output.roitable

wintab=pd.read_csv(windowed,sep='\t',header=None)
exctab=pd.read_csv(excessregion.sep='\t')
roitab=exctab
