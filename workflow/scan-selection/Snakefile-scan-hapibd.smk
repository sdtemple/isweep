...
# This version will run the selection scan using hap-ibd only
# Not using ibd-ends
# This may be appropriate in some founder populations
# where there is a high level of IBD
# The cheat code is just replacing the ibdends rule with
# another call to hap-ibd.jar
