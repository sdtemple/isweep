"""
Write SLiM script for forward simulations
...
ageSplit=snakemake.config['FIXED']['TSPLIT']
V=snakemake.config['FIXED']['NUMVAR']
L=snakemake.config['FIXED']['CMLEN']
m=snakemake.config['FIXED']['NUMSUBPOP']
q=snakemake.config['FIXED']['MIGRRATE']
rho=snakemake.config['FIXED']['RHO']
gcProp=snakemake.config['FIXED']['GCPROP']
gcMeanLength=snakemake.config['FIXED']['GCLEN']
Ne=snakemake.input.trueNe
a=snakemake.config['FIXED']['a']
b=snakemake.config['FIXED']['b']
equalSizes=snakemake.config['FIXED']['SAMPLEEQUAL']
sampleOneSubpop=snakemake.config['FIXED']['SAMPLEONE']

from random import randint
import numpy as np
import pandas as pd

macro=str(snakemake.config['FOLDERS']['MACRO'])
micro=str(snakemake.config["FOLDERS"]["MICRO"])
