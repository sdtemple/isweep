...
folder = '/home/guests/sdtemple/brwn/seth/imagene/Regression/LargeResults'
print(folder)
...
while i <= 20:
    ...
    # myfile = ImaFile(simulations_folder='/home/guests/sdtemple/brwn/seth/imagene/dev-training/Simulations1/Simulations' + str(i), nr_samples=1000, model_name='euramr-bottleneck')
    ...
    mygene = myfile.read_simulations(parameter_name='selection_coeff_hetero', max_nrepl=200)
...
# end of multiple CPU training
    ...
    score = model.fit(mygene.data, mygene.targets, batch_size=32, epochs=1, verbose=1, validation_split=0.20)
    print(score)
